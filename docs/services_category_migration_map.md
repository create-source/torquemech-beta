...
This document maps the current `services_catalog.json` categories to the proposed bumper-to-bumper taxonomy. It is a planning document only; existing live category keys and existing service assignments are preserved during Phase 3.1 Batch 5.
