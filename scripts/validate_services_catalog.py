...
REVIEWED_DUPLICATE_CONCEPT_ALLOWLIST: dict[frozenset[str], str] = {
    ...
    frozenset(("egr_cooler_diagnostic_diesel", "egr_cooler_replacement_diesel")): "diagnosis versus repair",
    ...
    frozenset(("glow_plug_diagnostic", "glow_plug_replacement_each")): "diagnosis versus per-component repair",
