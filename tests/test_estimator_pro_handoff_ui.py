...
class EstimatorProHandoffUiTests(unittest.TestCase):
    ...
    def test_stage_two_public_review_template_customer_safe_ui_hooks(self):
        ...
        self.assertIn("Confirm Approval", public_review_html)
        self.assertIn("Confirm Decline", public_review_html)
        self.assertIn("Confirm Decide Later", public_review_html)
